...
export default async function FosterNotificationsPage() {
  if (DEV_MODE) {
    return (
      <div className="max-w-2xl space-y-6">
        ...
        <NotificationsList notifications={[]} portal="foster" />
      </div>
    )
  }
  ...
  try {
    ...
    console.error('[foster/notifications] load failed:', e instanceof Error ? e.message : String(e))
    fetchError = true
  }
